...
namespace Demo.Repository.Person
{
    public class PersonRepository : IPersonRepository
    {
        ...
        public async Task<int> Delete(int id)
        {
            ...
            using (var connection = new SqlConnection(_connectionString))
            {
                result = await connection.ExecuteAsync("[dbo].[Ups_Del_DeletePerson]", parameters, commandType: CommandType.StoredProcedure);
            }
        ...
        public async Task<int> Update(Model.Person person)
        {
            ...
            using (var connection = new SqlConnection(_connectionString))
            {
                result = await connection.ExecuteAsync("[dbo].[Ups_Upd_UpdatePerson]", parameters, commandType: CommandType.StoredProcedure);
            }
